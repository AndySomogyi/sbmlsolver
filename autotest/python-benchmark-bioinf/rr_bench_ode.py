...
tests = [ \
  ('jean_marie', "./jean_marie/Jean_Marie_AMPA16_RobHow_v6.xml", 0.234, 0.0.024),
  ('jana_wolf', "./jana_wolf/Jana_WolfGlycolysis.xml", 0.189, 0.357),
  ('biomod14', "./biomod14/BIOMD0000000014.xml", 0.886, 0.036),
  ('biomod33', "./biomod33/BIOMD0000000033.xml", 0.191, 0.088),
  ('00001',   "./00001/00001-sbml-l2v4.xml", 0.084, 0.026),
  ('00002',   "./00002/00002-sbml-l2v4.xml", 0.086, 0.025),
  ('00050',  "./00050/00050-sbml-l2v4.xml",  0.389, 0.030),
  ('00100', "./00100/00100-sbml-l2v4.xml",   0.829, 0.035),
  ('00150', "./00150/00150-sbml-l2v4.xml",   1.230, 0.039),
  ('00200', "./00200/00200-sbml-l2v4.xml",   1.806, 0.044),
  ('00250', "./00250/00250-sbml-l2v4.xml",   3.236, 0.050),
  ('00300', "./00300/00300-sbml-l2v4.xml",   3.188, 0.055),
  ('00350', "./00350/00350-sbml-l2v4.xml",   4.130, 0.058),
  ('00400', "./00400/00400-sbml-l2v4.xml",   4.735, 0.069),
  ('00450', "./00450/00450-sbml-l2v4.xml",   5.211, 0.065),
  ('00500', "./00500/00500-sbml-l2v4.xml",   6.209, 0.071)]
