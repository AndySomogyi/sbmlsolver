...
tests = [ \
  ('jean_marie', "./jean_marie/Jean_Marie_AMPA16_RobHow_v6.xml", 0.2, 0.001),
  ('jana_wolf', "./jana_wolf/Jana_WolfGlycolysis.xml", 0.25, 0.3),
  ('biomod14', "./biomod14/BIOMD0000000014.xml", 0.8, 0.015),
  ('biomod33', "./biomod33/BIOMD0000000033.xml", 0.16, 0.1),
  ('00001',   "./00001/00001-sbml-l2v4.xml", 0.2, 0.001),
  ('00002',   "./00002/00002-sbml-l2v4.xml", 0.2, 0.001),
  ('00050',  "./00050/00050-sbml-l2v4.xml", 0.3, 0.015),
  ('00100', "./00100/00100-sbml-l2v4.xml", 0.9, 0.05),
  ('00150', "./00150/00150-sbml-l2v4.xml", 1.0, 0.06),
  ('00200', "./00200/00200-sbml-l2v4.xml", 2.0, 0.06),
  ('00250', "./00250/00250-sbml-l2v4.xml", 2.0, 0.07),
  ('00300', "./00300/00300-sbml-l2v4.xml", 2.25, 0.08),
  ('00350', "./00350/00350-sbml-l2v4.xml", 2.5, 0.08),
  ('00400', "./00400/00400-sbml-l2v4.xml", 3.2, 0.09),
  ('00450', "./00450/00450-sbml-l2v4.xml", 3.3, 0.09),
  ('00500', "./00500/00500-sbml-l2v4.xml", 4.0, 0.09)]
