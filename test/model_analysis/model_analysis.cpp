...
{
    RoadRunner* rr = new RoadRunner((rrTestDir_ / "/models/MODEL_ANALYSIS/event.xml").string());
...
{
    RoadRunner* rr = new RoadRunner((rrTestDir_ / "/models/MODEL_ANALYSIS/BIOMD0000000035_url.xml").string());
