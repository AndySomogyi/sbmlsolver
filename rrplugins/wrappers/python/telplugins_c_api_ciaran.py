...
class _Util:
    """
    Private _Utility class that is used to make the loading of telplugins classes and 
    methods easier. 
    """
    ...
    def load_lib() -> ct.CDLL:
        ...
        if sys.platform == "linux" or sys.platform == 'darwin':
            lib_path = os.path.join(_WORKING_DIRECTORY, "telplugins_c_api.so")
            if not os.path.isfile(lib_path):
                raise FileNotFoundError("Cannot find telplugins_c_api.so")
            lib = ct.CDLL(lib_path)

        elif sys.platform == "win32":
            # windows has to be difficult
            lib_path = os.path.join(_WORKING_DIRECTORY, "telplugins_c_api.dll")
            if not os.path.isfile(lib_path):
                raise FileNotFoundError("Cannot find telplugins_c_api.dll")
            ...
            raise ValueError("This ctypes api is not implemented for platform {sys.platform}")
        return lib

    @staticmethod
    def load_func(funcname: str, argtypes: List[str], restype) -> ct.CDLL._FuncPtr:
        """
        Load a function called `funcname` with argument types `argtypes` and return type `restype`

        Returns: a function pointer to a function called `funcname` from the telplugins_c_api.so library

        """
        func = _Util.load_lib().__getattr__(funcname)
...
class TelpluginsCAPI:
    ...
    ## \ingroup utilities
    rrpLib.tpGetCopyright.restype = ct.c_char_p
    ...
    ## \return Returns a string if successful, None otherwise
    ## \ingroup utilities
    rrpLib.tpGetVersion.restype = ct.c_char_p
    def getVersion():
    ...
    rrpLib.tpCreatePluginManager.restype = ct.c_void_p
    rrpLib.tpCreatePluginManager.argtypes = [ct.c_char_p]
    ...
    ##
    ## \ingroup plugin_manager
    rrpLib.tpFreePluginManager.restype = ct.c_bool
    rrpLib.tpFreePluginManager.argtypes = [ct.c_void_p]
    ...
    ## \endhtmlonly
    ## \ingroup plugin_manager
    rrpLib.tpLoadPlugins.restype = ct.c_bool
    rrpLib.tpLoadPlugins.argtypes = [ct.c_void_p]
    def loadPlugins(pm):
    ...
    ## \ingroup plugin_manager
    rrpLib.tpGetPluginLoadErrors.restype = ct.c_char_p
    rrpLib.tpGetPluginLoadErrors.argtypes = [ct.c_void_p]
    ...
    ## \ingroup plugin_manager
    ##
    rrpLib.tpUnLoadPlugins.restype = ct.c_bool
    rrpLib.tpUnLoadPlugins.argtypes = [ct.c_void_p]
    ...
    ## \ingroup plugin_manager
    ##
    rrpLib.tpLoadPlugin.restype = ct.c_void_p
    rrpLib.tpLoadPlugin.argtypes = [ct.c_void_p, ct.c_char_p]
    ...
    ## \ingroup plugin_manager
    ##
    rrpLib.tpUnLoadPlugin.restype = ct.c_bool
    rrpLib.tpUnLoadPlugin.argtypes = [ct.c_void_p]
    ...
    rrpLib.tpGetNumberOfPlugins.argtypes = [ct.c_void_p]
    ...
    ## \endhtmlonly
    ## \ingroup plugin_manager
    rrpLib.tpGetPluginNames.restype = ct.c_void_p
    rrpLib.tpGetPluginNames.argtypes = [ct.c_void_p]
    def getPluginNames(pm):
        names = rrpLib.tpGetPluginNames(pm)
        res = decodeIfBytes(ctypes.cast(names, ctypes.ct.c_char_p).value)
        freeText(names)
        if not res:
            return list()
        return res.split(",")
    ...
    ## \endhtmlonly
    ## \ingroup plugin_manager
    rrpLib.tpGetPluginLibraryNames.restype = ct.c_char_p
    rrpLib.tpGetPluginLibraryNames.argtypes = [ct.c_void_p]
    ...
    ## \ingroup plugin_manager
    rrpLib.tpGetFirstPlugin.restype = ct.c_void_p
    rrpLib.tpGetFirstPlugin.argtypes = [ct.c_void_p]
    ...
    ## \return Returns a handle to a plugin. Returns None if the plugin is not found
    ## \ingroup plugin_manager
    rrpLib.tpGetNextPlugin.restype = ct.c_void_p
    rrpLib.tpGetNextPlugin.argtypes = [ct.c_void_p]
    ...
    ## \return Returns a handle to a plugin. Returns None if the plugin is not found
    ## \ingroup plugin_manager
    rrpLib.tpGetPreviousPlugin.restype = ct.c_void_p
    rrpLib.tpGetPreviousPlugin.argtypes = [ct.c_void_p]
    ...
    ## \return Returns a handle to a plugin. Returns None if the plugin is not found
    ## \ingroup plugin_manager
    rrpLib.tpGetCurrentPlugin.restype = ct.c_void_p
    rrpLib.tpGetCurrentPlugin.argtypes = [ct.c_void_p]
    ...
    ## \ingroup plugin_manager
    rrpLib.tpGetPlugin.restype = ct.c_void_p
    rrpLib.tpGetPlugin.argtypes = [ct.c_void_p, ct.c_char_p]
    def getPlugin(pm, pluginName):
        return rrpLib.tpGetPlugin(pm, ct.c_char_p(pluginName.encode('utf-8')))
    ...
    ## \endhtmlonly
    ## \ingroup plugins
    rrpLib.tpGetPluginName.restype = ct.c_char_p
    rrpLib.tpGetPluginName.argtypes = [ct.c_void_p]
    ...
    ## \endhtmlonly
    ## \ingroup plugins
    rrpLib.tpGetPluginCategory.restype = ct.c_void_p
    rrpLib.tpGetPluginCategory.argtypes = [ct.c_void_p]
    def getPluginCategory(pluginHandle):
        data =  rrpLib.tpGetPluginCategory(pluginHandle)
        res = decodeIfBytes(ctypes.cast(data, ctypes.ct.c_char_p).value)
        freeText(data)
        return res
    ...
    ## \return Returns a string if successful, None otherwise
    ## \ingroup plugins
    rrpLib.tpGetPluginAuthor.restype = ct.c_void_p
    rrpLib.tpGetPluginAuthor.argtypes = [ct.c_void_p]
    ...
    ## \return Returns a string if successful, None otherwise
    ## \ingroup plugins
    rrpLib.tpGetPluginCopyright.restype = ct.c_void_p
    rrpLib.tpGetPluginCopyright.argtypes = [ct.c_void_p]
    ...
    ## \return Returns a string if successful, None otherwise
    ## \ingroup plugins
    rrpLib.tpGetPluginVersion.restype = ct.c_void_p
    rrpLib.tpGetPluginVersion.argtypes = [ct.c_void_p]
    def getPluginVersion(pluginHandle):
        ptr = rrpLib.tpGetPluginVersion(pluginHandle)
        res = decodeIfBytes(ctypes.cast(ptr, ctypes.ct.c_char_p).value)
        freeText(ptr)
        return res
    ...
    ## \endhtmlonly
    ## \ingroup plugins
    rrpLib.tpGetPluginDescription.restype = ct.c_void_p
    rrpLib.tpGetPluginDescription.argtypes = [ct.c_void_p]
    ...
    ## \endhtmlonly
    ## \ingroup plugins
    rrpLib.tpGetPluginHint.restype = ct.c_void_p
    rrpLib.tpGetPluginHint.argtypes = [ct.c_void_p]
    ...
    ## \ingroup plugins
    rrpLib.tpGetPluginInfo.restype = ct.c_char_p
    rrpLib.tpGetPluginInfo.argtypes = [ct.c_void_p]
    ...
    rrpLib.tpGetPluginManualAsPDF.argtypes = [ct.c_void_p]
    ...
    rrpLib.tpGetPluginManualNrOfBytes.argtypes = [ct.c_void_p]
    ...
    ## \ingroup plugins
    rrpLib.tpExecutePlugin.restype = ct.c_bool
    rrpLib.tpExecutePlugin.argtypes = [ct.c_void_p]
    ...
    ## \return Returns true or false indicating success/failure
    ## \ingroup plugins
    rrpLib.tpExecutePluginEx.restype = ct.c_bool
    rrpLib.tpExecutePluginEx.argtypes = [ct.c_void_p, ct.c_bool]
    def executePluginEx(pluginHandle, inAThread=False):
        return rrpLib.tpExecutePluginEx(pluginHandle, ct.c_bool(inAThread))
    ...
    ## \ingroup plugins
    rrpLib.tpGetPluginStatus.restype = ct.c_char_p
    rrpLib.tpGetPluginStatus.argtypes = [ct.c_void_p]
    ...
    ## \ingroup plugins
    rrpLib.tpGetPluginResult.restype = ct.c_char_p
    rrpLib.tpGetPluginResult.argtypes = [ct.c_void_p]
    ...
    ## \return Returns true or false indicating success/failure
    ## \ingroup plugins
    rrpLib.tpResetPlugin.restype = ct.c_bool
    rrpLib.tpResetPlugin.argtypes = [ct.c_void_p]
    ...
    ## \ingroup plugins
    rrpLib.tpIsPluginWorking.restype = ct.c_bool
    rrpLib.tpIsPluginWorking.argtypes = [ct.c_void_p]
    ...
    ## \return Returns true or false indicating success/failure
    ## \ingroup plugins
    rrpLib.tpTerminateWork.restype = ct.c_bool
    rrpLib.tpTerminateWork.argtypes = [ct.c_void_p]
    ...
    ## \ingroup plugins
    rrpLib.tpIsBeingTerminated.restype = ct.c_bool
    rrpLib.tpIsBeingTerminated.argtypes = [ct.c_void_p]
    ...
    ## \ingroup plugins
    rrpLib.tpWasTerminated.restype = ct.c_bool
    rrpLib.tpWasTerminated.argtypes = [ct.c_void_p]
    ...
    ## \return Returns true or false indicating success/failure
    ## \ingroup plugins
    rrpLib.tpAssignOnStartedEvent.restype = ct.c_bool
    rrpLib.tpAssignOnStartedEvent.argtypes =[ct.c_void_p, NotifyEvent, ct.c_void_p]
    ...
    ## \return Returns true or false indicating success/failure
    ## \ingroup plugins
    rrpLib.tpAssignOnProgressEvent.restype = ct.c_bool
    rrpLib.tpAssignOnProgressEvent.argtypes =[ct.c_void_p, ct.c_void_p, ct.c_void_p]
    ...
    ## \return Returns true or false indicating success/failure
    ## \ingroup plugins
    rrpLib.tpAssignOnFinishedEvent.restype = ct.c_bool
    rrpLib.tpAssignOnFinishedEvent.argtypes =[ct.c_void_p, NotifyEvent, ct.c_void_p]
    ...
    rrpLib.tpGetPluginProperties.restype = ct.c_void_p
    rrpLib.tpGetPluginProperties.argtypes = [ct.c_void_p]
    ...
    ## \ingroup plugin_properties
    rrpLib.tpGetListOfPluginPropertyNames.restype = ct.c_char_p
    rrpLib.tpGetListOfPluginPropertyNames.argtypes = [ct.c_void_p]
    ...
    ## \ingroup plugin_properties
    rrpLib.tpClearPropertyList.restype = ct.c_bool
    rrpLib.tpClearPropertyList.argtypes = [ct.c_void_p]
    ...
    ## \ingroup plugin_properties
    rrpLib.tpGetNamesFromPropertyList.restype = ct.c_char_p
    rrpLib.tpGetNamesFromPropertyList.argtypes = [ct.c_void_p]
    ...
    ## \ingroup plugin_properties
    rrpLib.tpGetPluginPropertiesAsXML.restype = ct.c_char_p
    rrpLib.tpGetPluginPropertiesAsXML.argtypes = [ct.c_void_p]
    ...
    ## \ingroup plugin_properties
    rrpLib.tpGetFirstProperty.restype = ct.c_void_p
    rrpLib.tpGetFirstProperty.argtypes = [ct.c_void_p]
    ...
    ## \return Returns a handle to a property. Returns None if not found
    ## \ingroup plugin_properties
    rrpLib.tpGetNextProperty.restype = ct.c_void_p
    rrpLib.tpGetNextProperty.argtypes = [ct.c_void_p]
    ...
    ## \ingroup plugin_properties
    rrpLib.tpGetPluginProperty.restype = ct.c_void_p
    rrpLib.tpGetPluginProperty.argtypes = [ct.c_void_p, ct.c_char_p]
    ...
    ## \ingroup plugin_properties
    rrpLib.tpSetPluginProperty.restype = ct.c_bool
    rrpLib.tpSetPluginProperty.argtypes = [ct.c_void_p, ct.c_char_p, ct.c_char_p]
    ...
    ## \ingroup plugin_properties
    rrpLib.tpSetPropertyDescription.restype = ct.c_bool
    rrpLib.tpSetPropertyDescription.argtypes = [ct.c_void_p, ct.c_char_p]
    ...
    ## \ingroup plugin_properties
    rrpLib.tpGetPropertyDescription.restype = ct.c_char_p
    rrpLib.tpGetPropertyDescription.argtypes = [ct.c_void_p]
    def getPropertyDescription(propertyHandle):
        descr = rrpLib.tpGetPropertyDescription(propertyHandle)
        if descr is None:
            return None

        val = decodeIfBytes(ctypes.cast(descr, ctypes.ct.c_char_p).value)
        freeText(descr)
        return val
    ...
    ## \return Returns true if successful, false otherwise
    ## \ingroup plugin_properties
    rrpLib.tpSetPropertyHint.restype = ct.c_bool
    rrpLib.tpSetPropertyHint.argtypes = [ct.c_void_p, ct.c_char_p]
    ...
    ## \endhtmlonly
    ## \ingroup plugin_properties
    rrpLib.tpCreateProperty.restype = ct.c_void_p
    rrpLib.tpCreateProperty.argtypes = [ct.c_char_p, ct.c_char_p, ct.c_char_p, ct.c_void_p]
    ...
    ## \return Returns true if successful, false otherwise
    ## \ingroup plugin_properties
    rrpLib.tpFreeProperty.restype = ct.c_bool
    rrpLib.tpFreeProperty.argtypes = [ct.c_void_p]
    ...
    ## \endhtmlonly
    ## \ingroup plugin_properties
    rrpLib.tpAddPropertyToList.restype = ct.c_bool
    rrpLib.tpAddPropertyToList.argtypes = [ct.c_void_p, ct.c_void_p]
    ...
    ## \return Returns true if successful, false otherwise
    ## \ingroup plugin_properties
    rrpLib.tpSetPropertyByString.restype = ct.c_bool
    rrpLib.tpSetPropertyByString.argtypes = [ct.c_void_p, ct.c_char_p]
    ...
    ## \ingroup plugin_properties
    rrpLib.tpGetPropertyInfo.restype = ct.c_char_p
    rrpLib.tpGetPropertyInfo.argtypes = [ct.c_void_p]
    ...
    ## \ingroup plugin_properties
    rrpLib.tpGetPropertyValueAsString.restype = ct.c_char_p
    rrpLib.tpGetPropertyValueAsString.argtypes = [ct.c_void_p]
    ...
    ## \endhtmlonly
    ## \ingroup plugin_properties
    rrpLib.tpGetPropertyValueHandle.restype = ct.c_void_p
    rrpLib.tpGetPropertyValueHandle.argtypes = [ct.c_void_p]
    ...
    ## \ingroup plugin_properties
    rrpLib.tpGetPropertyName.restype = ct.c_char_p
    rrpLib.tpGetPropertyName.argtypes = [ct.c_void_p]
    ...
    ## \ingroup plugin_properties
    rrpLib.tpGetPropertyHint.restype = ct.c_char_p
    rrpLib.tpGetPropertyHint.argtypes = [ct.c_void_p]
    ...
    ## \ingroup plugin_properties
    rrpLib.tpGetPropertyType.restype = ct.c_char_p
    rrpLib.tpGetPropertyType.argtypes = [ct.c_void_p]
    ...
    ## \ingroup plugin_properties
    rrpLib.tpGetBoolProperty.restype = ct.c_bool
    rrpLib.tpGetBoolProperty.argtypes = [ct.c_void_p, ct.c_bool_p]
    ...
    ## \return Returns true if successful, false otherwise
    ## \ingroup plugin_properties
    rrpLib.tpSetBoolProperty.restype = ct.c_bool
    rrpLib.tpSetBoolProperty.argtypes = [ct.c_void_p, ct.c_bool]
    def setBoolProperty(propertyHandle, value):
        return rrpLib.tpSetBoolProperty (propertyHandle, ct.c_bool(value))
    ...
    rrpLib.tpGetIntProperty.argtypes = [ct.c_void_p, c_int_p]
    ...
    ## \return Returns true if successful, false otherwise
    ## \ingroup plugin_properties
    rrpLib.tpSetIntProperty.restype = ct.c_bool
    rrpLib.tpSetIntProperty.argtypes = [ct.c_void_p, c_int]
    ...
    rrpLib.tpGetDoubleProperty.argtypes = [ct.c_void_p, c_double_p]
    ...
    ## \return Returns true if successful, false otherwise
    ## \ingroup plugin_properties
    rrpLib.tpSetDoubleProperty.restype = ct.c_bool
    rrpLib.tpSetDoubleProperty.argtypes = [ct.c_void_p, c_double]
    ...
    ## \ingroup plugin_properties
    rrpLib.tpGetStringProperty.restype = ct.c_bool
    rrpLib.tpGetStringProperty.argtypes = [ct.c_void_p, ct.c_char_p]
    ...
    ## \return Returns true if successful, false otherwise
    ## \ingroup plugin_properties
    rrpLib.tpSetStringProperty.restype = ct.c_bool
    rrpLib.tpSetStringProperty.argtypes = [ct.c_void_p, ct.c_char_p]
    def setStringProperty(propertyHandle, value):
        r = rrpLib.tpSetStringProperty(propertyHandle, ct.c_char_p(value.encode('utf-8')))
        if not r:
    ...
    ## \ingroup plugin_properties
    rrpLib.tpGetListProperty.restype = ct.c_bool
    rrpLib.tpGetListProperty.argtypes = [ct.c_void_p, ct.c_void_p]
    ...
    ## \return Returns true if successful, false otherwise
    ## \ingroup plugin_properties
    rrpLib.tpSetListProperty.restype = ct.c_bool
    rrpLib.tpSetListProperty.argtypes = [ct.c_void_p, ct.c_void_p]
    def setListProperty(propertyHandle, value):
        handle = getPropertyValueHandle(value)
        return rrpLib.tpSetListProperty(propertyHandle, ct.c_void_p(handle))
    ...
    ## \return Returns true if successful, false otherwise
    ## \ingroup plugin_properties
    rrpLib.tpSetTelluriumDataProperty.restype = ct.c_bool
    rrpLib.tpSetTelluriumDataProperty.argtypes = [ct.c_void_p, ct.c_void_p]
    def setTelluriumDataProperty(propertyHandle, value):
        return rrpLib.tpSetTelluriumDataProperty(propertyHandle, ct.c_void_p(value))
    ...
    def getProperty(propertyHandle):
        ...
        if paraType == 'bool':
            ...
            ptr = cast(paraVoidPtr, POINTER(ct.c_bool))
            return ptr[0]
    ...
    ## \return Returns a numpy data object
    ## \ingroup utilities
    rrpLib.tpGetTelluriumDataColumnHeader.restype = ct.c_void_p
    rrpLib.tpGetTelluriumDataColumnHeader.argtypes = [ct.c_void_p]
    def getTelluriumDataColumnHeader(telDataHandle):
        ...
        if hdr:
            res = decodeIfBytes(ctypes.cast(hdr, ctypes.ct.c_char_p).value)
            freeText(hdr)
            return res.split(',')
        else:
            return None
    ...
    ## \ingroup utilities
    rrpLib.tpGetTelluriumDataColumnHeaderByIndex.restype = ct.c_char_p
    rrpLib.tpGetTelluriumDataColumnHeaderByIndex.argtypes = [ct.c_void_p, c_int]
    ...
    ## \ingroup utilities
    rrpLib.tpSetTelluriumDataColumnHeader.restype = ct.c_bool
    rrpLib.tpSetTelluriumDataColumnHeader.argtypes = [ct.c_void_p, ct.c_char_p]
    ...
    ## \return True or false indicating success
    ## \ingroup utilities
    rrpLib.tpSetTelluriumDataColumnHeaderByIndex.restype = ct.c_bool
    rrpLib.tpSetTelluriumDataColumnHeaderByIndex.argtypes = [ct.c_void_p, c_int, ct.c_char_p] #FIXME: Out of order
    ...
    ## \ingroup utilities
    rrpLib.tpGetTelluriumDataElement.restype = ct.c_bool
    rrpLib.tpGetTelluriumDataElement.argtypes = [ct.c_void_p, c_int, c_int, c_double_p]
    ...
    ## \return Returns the numeric value at row,col
    ## \ingroup utilities
    rrpLib.tpSetTelluriumDataElement.restype = ct.c_bool
    rrpLib.tpSetTelluriumDataElement.argtypes = [ct.c_void_p, c_int, c_int, c_double]
    ...
    ## \return Returns the numeric value at row,col
    ## \ingroup utilities
    rrpLib.tpGetTelluriumDataWeight.restype = ct.c_bool
    rrpLib.tpGetTelluriumDataWeight.argtypes = [ct.c_void_p, c_int, c_int, c_double_p]
    ...
    ## \return Returns the numeric value at row,col
    ## \ingroup utilities
    rrpLib.tpSetTelluriumDataWeight.restype = ct.c_bool
    rrpLib.tpSetTelluriumDataWeight.argtypes = [ct.c_void_p, c_int, c_int, c_double]
    ...
    rrpLib.tpGetTelluriumDataNumRows.argtypes = [ct.c_void_p]
    ...
    rrpLib.tpGetTelluriumDataNumCols.argtypes = [ct.c_void_p]
    ...
    ## \ingroup utilities
    rrpLib.tpWriteTelluriumDataToFile.restype = ct.c_bool
    rrpLib.tpWriteTelluriumDataToFile.argtypes = [ct.c_void_p, ct.c_char_p]
    ...
    ## \return Returns True or false indicating result
    ## \ingroup utilities
    rrpLib.tpReadTelluriumDataFromFile.restype = ct.c_bool
    rrpLib.tpReadTelluriumDataFromFile.argtypes = [ct.c_void_p, ct.c_char_p]
    ...
    ## \ingroup utilities
    rrpLib.tpCreateTelluriumData.restype = ct.c_void_p
    rrpLib.tpCreateTelluriumData.argtypes = [c_int, c_int, ct.c_char_p]
    ...
    ## \ingroup utilities
    rrpLib.tpHasWeights.restype = ct.c_bool
    rrpLib.tpHasWeights.argtypes = [ct.c_void_p, ct.c_bool_p]
    ...
    ## \ingroup utilities
    rrpLib.tpAllocateWeights.restype = ct.c_bool
    rrpLib.tpAllocateWeights.argtypes = [ct.c_void_p, ct.c_bool_p]
    ...
    ## \return Returns True or false indicating result
    ## \ingroup utilities
    rrpLib.tpFreeTelluriumData.restype = ct.c_bool
    rrpLib.tpFreeTelluriumData.argtypes = [ct.c_void_p]
    ...
    ## \ingroup utilities
    rrpLib.tpGetLastError.restype = ct.c_char_p
    def getLastError():
    ...
    rrpLib.tpGetDataArray.argtypes = [ct.c_void_p]
    ...
    rrpLib.tpGetMatrixNumRows.argtypes = [ct.c_void_p]
    ...
    rrpLib.tpGetMatrixNumCols.argtypes = [ct.c_void_p]
    ...
    rrpLib.tpSetLogLevel.restype = ct.c_bool
    rrpLib.tpSetLogLevel.argtypes = [ct.c_char_p]
    def setLogLevel(lvl):
