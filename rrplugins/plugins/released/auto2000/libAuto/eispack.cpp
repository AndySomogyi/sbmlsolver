...
L999:
    if (*idbg > 0) {
      integer c__1 = 1;
      fprintf(fp6, "top of loop\n");
      fprintf(fp6, "oldll,oldm,oldacc,m,iter,maxit,ifull,thresh=%ld,%ld,%ld,%ld,%ld,%ld,%ld,%f\n",
...
/*     e(ll) ... e(m-1) are nonzero */
    if (*idbg > 0) {
      fprintf(fp6, "work on block ll,m=%ld,%ld\n",ll,m);    
      fprintf(fp6, "smin=%f\n",smin);
...
/*             test for negligibility satisfied */
            if (*idbg >= 1) {
                    fprintf(fp6, "knew: e(lll),lambda=%f,%f\n",e[lll],lambda);
            }
            e[lll] = 0.;
            goto L999;
        } else {
...
/*       smallest singular value */
    shift = 0.;
    if (*idbg > 0) {
            fprintf(fp6, "sminl test for shift is zero\n");
    }
    } else {
...
/*       compute shift from 2 by 2 block at end of matrix */
    ...
    if (*idbg > 0) {
            fprintf(fp6, "smm1,emm1,sm=%f,%f,%f\n",smm1,emm1,sm);
    }
    shift = sigmin(&smm1, &emm1, &sm);
    if (*idbg > 0) {
      fprintf(fp6, "sigma-min of 2 by 2 corner=%f\n",shift);
    }
    if (*tol > (double)0.) {
        if (shift > nct * smin) {
        ++(*limshf);
...
/*       if idir=1, chase bulge from top to bottom */
    if (idir == 1) {
        if (*idbg > 2) {
                fprintf(fp6, "qr with zero shift, top to bottom\n");
        }
        oldcs = 1.;
        f = s[ll];
        g = e[ll];
...
/*         test convergence */
        if (*idbg > 0) {
                fprintf(fp6, "convergence decision for zero shift top to bottom\n");
                  fprintf(fp6, "e(m-1), threshold=%f,%f\n",e[m - 1],thresh);
        if ((d__1 = e[m - 1], fabs(d__1)) <= thresh) {
                fprintf(fp6, "***converged***\n");
        }
        }
        if ((d__1 = e[m - 1], fabs(d__1)) <= thresh) {
        e[m - 1] = 0.;
...
/*       (idir=2, so chase bulge from bottom to top) */
        if (*idbg > 2) {
      fprintf(fp6, "qr with zero shift, bottom to top\n");
        }
        oldcs = 1.;
        f = s[m];
        g = e[m - 1];
...
/*         test convergence */
        if (*idbg > 0) {
                fprintf(fp6, "convergence decision for zero shift bottom to top\n");
                  fprintf(fp6, "e(ll), threshold=%f,%f\n",e[ll],thresh);
...
/*       if idir=1, chase bulge from top to bottom */
    if (idir == 1) {
        ...
        if (*idbg > 2) {
                fprintf(fp6, "qr with nonzero shift, top to bottom\n");
        }
...
/*         check convergence */
        if (*idbg > 0) {
                fprintf(fp6, "convergence decision for shift top to bottom\n");
                  fprintf(fp6, "e(m-1), threshold=%f,%f\n",e[m - 1],thresh);
        if ((d__1 = e[m - 1], fabs(d__1)) <= thresh) {
          fprintf(fp6, "***converged***\n");
        }
...
/*       (idir=2, so chase bulge from bottom to top) */
            doublereal c_b170 = 1.;
        if (*idbg > 2) {
                fprintf(fp6, "qr with nonzero shift, bottom to top\n");
        }
...
/*         test convergence */
        if (*idbg > 0) {
                fprintf(fp6, "convergence decision for shift bottom to top\n");
                  fprintf(fp6, "e(ll), threshold=%f,%f\n",e[ll],thresh);
...
/*     debug routine to print s,e */
    ...
    /* Function Body */
    fprintf(fp6, "                      s(.)                       e(.) for ll,m=%ld,%ld\n",(*ll),(*m));
    i__1 = *m - 1;
    for (i__ = *ll; i__ <= i__1; ++i__) {
      fprintf(fp6, "%26.17f %26.17f\n",s[i__],e[i__]);
...
sig22(doublereal *a, doublereal *b, doublereal *c__, doublereal *sigmin, doublereal *sigmax, doublereal *snr, doublereal *csr, doublereal *snl, doublereal *csl)
{
    ...
    /* Local variables */
    doublereal absa, absb, absc, acmn, acmx, sgna, sgnb, sgnc, cosl, 
...
sigmin(doublereal *a, doublereal *b, doublereal *c__)
{
    ...
    /* Local variables */
    doublereal acmn, acmx, aa, ab, ac, as, at, au;
...
hqr3lc(doublereal *a, doublereal *v, integer *n, integer *nlow, integer *nup, doublereal *eps, doublereal *er, doublereal *ei, integer *type__, integer *na, integer *nv, integer *imfd)
{
    ...
    logical fail;
    integer i__, l;
    doublereal p, q, r__, s, t, w, x, y, z__, e1, e2;
...
split(doublereal *a, doublereal *v, integer *n, integer *l, doublereal *e1, doublereal *e2, integer *na, integer *nv)
{
    ...
    /* Local variables */
    integer i__, j;
    doublereal p, q, r__, t, u, w, x, y, z__;
    integer l1;
...
exchng(doublereal *a, doublereal *v, integer *n, integer *l, integer *b1, integer *b2, doublereal *eps, logical *fail, integer *na, integer *nv)
{
    ...
    /* Local variables */
    integer i__, j, m;
    doublereal p, q, r__, s, w, x, y, z__;
    integer l1, it;
...
qrstep(doublereal *a, doublereal *v, doublereal *p, doublereal *q, doublereal *r__, integer *nl, integer *nu, integer *n, integer *na, integer *nv)
{
    ...
    logical last;
    integer i__, j, k;
    doublereal s, x, y, z__;
    integer nl2, nl3, num1;
