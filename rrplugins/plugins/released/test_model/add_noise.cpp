...
#include "../add_noise/noise.h"
#include "../add_noise/add_noise_doc.h"
...
AddNoise::AddNoise(PluginEvent fn1, PluginEvent fn2, PluginEvent fn3):
...
{
    RRPLOG(lInfo)<<"Executing the AddNoise plugin by Totte Karlsson";
