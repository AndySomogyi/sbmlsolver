...
public:
     ...
     */
    SBMLSolverOptions roadRunnerOptions;
...
int SBMLSolver::getInstanceCount()
{
    return mInstanceCount;
}

int SBMLSolver::getInstanceID()
{
    return impl->mInstanceID;
}

SBMLSolver::SBMLSolver() : impl(new RoadRunnerImpl("", NULL))
{
...
SBMLSolver::SBMLSolver(const std::string& uriOrSBML,
...
SBMLSolver::SBMLSolver(const string& _compiler, const string& _tempDir,
...
SBMLSolver::~SBMLSolver()
{
    delete impl;
}

ExecutableModel* SBMLSolver::getModel()
{
    return impl->model;
}

void SBMLSolver::setOptions(const SBMLSolverOptions& opt)
{
    impl->roadRunnerOptions = opt;
}

vector<SelectionRecord> SBMLSolver::getSelectionList()
{
    return impl->mSelectionList;
}

string SBMLSolver::getInfo()
{
...
string SBMLSolver::getExtendedVersionInfo()
{
    stringstream info;
...
ls::LibStructural* SBMLSolver::getLibStruct()
{
...
Compiler* SBMLSolver::getCompiler()
{
    return impl->compiler;
}


void SBMLSolver::setCompiler(const string& compiler)
{
    impl->loadOpt.setItem("compiler", compiler);
}

bool SBMLSolver::isModelLoaded()
{
    return impl->model ? true : false;
}

void SBMLSolver::setSimulateOptions(const SimulateOptions& settings)
{
    impl->simulateOpt = settings;
}

SimulateOptions& SBMLSolver::getSimulateOptions()
{
    return impl->simulateOpt;
}

bool SBMLSolver::getConservedMoietyAnalysis()
{
    return impl->loadOpt.getConservedMoietyConversion();
}

void SBMLSolver::setTempDir(const string& folder)
{
    impl->loadOpt.setItem("tempDir", folder);
}

string SBMLSolver::getTempDir()
{
    return impl->loadOpt.getItem("tempDir");
}

int SBMLSolver::createDefaultTimeCourseSelectionList()
{
...
int SBMLSolver::createTimeCourseSelectionList()
{
...
string SBMLSolver::getParamPromotedSBML(const string& sbml)
{
 ...
 * to point to it.
 */
void SBMLSolver::updateIntegrator()
{
    get_self();
...
double SBMLSolver::getValue(const SelectionRecord& record)
{
    if (!impl->model)
    {
...
double SBMLSolver::getNthSelectedOutput(unsigned index, double currentTime)
{
...
void SBMLSolver::getSelectedValues(DoubleMatrix& results, int nRow, double currentTime)
{
...
void SBMLSolver::getSelectedValues(std::vector<double>& results,
        double currentTime)
{
...
vector<double> SBMLSolver::getConservedMoietyValues()
{
    return getLibStruct()->getConservedSums();
}

void SBMLSolver::load(const string& uriOrSbml, const Dictionary *dict)
{
    Mutex::ScopedLock lock(roadRunnerMutex);
...
bool SBMLSolver::createDefaultSelectionLists()
{
    bool result = true;
...
void SBMLSolver::reset()
{
    uint opt = rr::Config::getInt(rr::Config::MODEL_RESET);
    reset(opt);
}

void SBMLSolver::reset(int options)
{
    if (impl->model)
    {
...
bool SBMLSolver::populateResult()
{
...
std::vector<rr::SelectionRecord>& SBMLSolver::getSelections()
{
    return impl->mSelectionList;
}


double SBMLSolver::steadyState(const Dictionary* dict)
{
    if (!impl->model)
    {
        throw CoreException(gEmptyModelMessage);
    ...
    if (!impl->loadOpt.getConservedMoietyConversion() &&
            (Config::getBool(Config::SBMLSOLVER_DISABLE_WARNINGS)
                & Config::SBMLSOLVER_DISABLE_WARNINGS_STEADYSTATE) == 0)
    {
        ...
        Log(Logger::LOG_WARNING) << "to remove this warning, set SBMLSOLVER_DISABLE_WARNINGS to 1 or 3 in the config file";
    }
...
void SBMLSolver::setConservedMoietyAnalysis(bool value)
{
    get_self();
...
double SBMLSolver::getEE(const string& reactionName, const string& parameterName)
{
    return getEE(reactionName, parameterName, true);
}

double SBMLSolver::getEE(const string& reactionName, const string& parameterName, bool computeSteadyState)
{
...
double SBMLSolver::getuEE(const string& reactionName, const string& parameterName)
{
    return getuEE(reactionName, parameterName, true);
}

double SBMLSolver::getuEE(const string& reactionName, const string& parameterName, bool computeSteadystate)
{
    try
    {
        if (!impl->model)
...
const DoubleMatrix* SBMLSolver::simulate(const Dictionary* dict)
{
    get_self();
    check_model();
...
double SBMLSolver::integrate(double t0, double tf, const SimulateOptions* o)
{
    check_model();
    updateSimulateOptions();
...
double SBMLSolver::oneStep(const double currentTime, const double stepSize, const bool reset)
{
    get_self();
    check_model();
    updateSimulateOptions();
...
std::vector<ls::Complex> SBMLSolver::getFullEigenValues()
{
    return getEigenValues(JACOBIAN_FULL);
}


std::vector<ls::Complex> SBMLSolver::getReducedEigenValues()
{
    return getEigenValues(JACOBIAN_REDUCED);
}

std::vector< std::complex<double> > SBMLSolver::getEigenValues(SBMLSolver::JacobianMode mode)
{
    check_model();
    DoubleMatrix mat;
...
DoubleMatrix SBMLSolver::getFullJacobian()
{
    check_model();
...
DoubleMatrix SBMLSolver::getFullReorderedJacobian()
{
    check_model();
...
DoubleMatrix SBMLSolver::getReducedJacobian(double h)
{
    get_self();
    ...
    if (Config::getValue(Config::SBMLSOLVER_JACOBIAN_MODE).convert<unsigned>()
            == Config::SBMLSOLVER_JACOBIAN_MODE_AMOUNTS)
    {
...
DoubleMatrix SBMLSolver::getLinkMatrix()
{
    check_model();
...
DoubleMatrix SBMLSolver::getReducedStoichiometryMatrix()
{
    return getNrMatrix();
}

DoubleMatrix SBMLSolver::getNrMatrix()
{
    check_model();
...
DoubleMatrix SBMLSolver::getKMatrix()
{
    check_model();
...
DoubleMatrix SBMLSolver::getFullStoichiometryMatrix()
{
    check_model();
    get_self();
    ls::LibStructural *ls = getLibStruct();
...
DoubleMatrix SBMLSolver::getL0Matrix()
{
    check_model();
    ls::LibStructural *ls = getLibStruct();
...
DoubleMatrix SBMLSolver::getConservationMatrix()
{
    DoubleMatrix mat;
...
int SBMLSolver::getNumberOfDependentSpecies()
{
    try
    {
        if (impl->model)
...
int SBMLSolver::getNumberOfIndependentSpecies()
{
    try
    {
        if (impl->model)
...
double SBMLSolver::getVariableValue(const VariableType variableType,
...
int SBMLSolver::createDefaultSteadyStateSelectionList()
{
...
vector<SelectionRecord>& SBMLSolver::getSteadyStateSelections()
{
    return impl->mSteadyStateSelection;
}

vector<double> SBMLSolver::getSteadyStateValues()
{
    if (!impl->model)
    {
        throw CoreException(gEmptyModelMessage);
...
string SBMLSolver::getModelName()
{
...
int SBMLSolver::getNumberOfReactions()
{
    if (!impl->model)
    {
        throw CoreException(gEmptyModelMessage);
...
double SBMLSolver::getReactionRate(const int& index)
{
    if (!impl->model)
    {
        throw CoreException(gEmptyModelMessage);
...
double SBMLSolver::getRateOfChange(const int& index)
{
    if (!impl->model)
    {
        throw CoreException(gEmptyModelMessage);
...
int SBMLSolver::getNumberOfCompartments()
{
    if (!impl->model)
    {
        throw CoreException(gEmptyModelMessage);
...
void SBMLSolver::setCompartmentByIndex(const int& index, const double& value)
{
    if (!impl->model)
    {
         throw CoreException(gEmptyModelMessage);
...
double SBMLSolver::getCompartmentByIndex(const int& index)
{
    if (!impl->model)
    {
        throw CoreException(gEmptyModelMessage);
...
int SBMLSolver::getNumberOfBoundarySpecies()
{
    if (!impl->model)
    {
...
void SBMLSolver::setBoundarySpeciesByIndex(const int& index, const double& value)
{
    if (!impl->model)
    {
        throw Exception(gEmptyModelMessage);
...
double SBMLSolver::getBoundarySpeciesByIndex(const int& index)
{
    if (!impl->model)
    {
        throw Exception(gEmptyModelMessage);
...
vector<double> SBMLSolver::getBoundarySpeciesConcentrations()
{
    if (!impl->model)
    {
        throw CoreException(gEmptyModelMessage);
...
int SBMLSolver::getNumberOfFloatingSpecies()
{
    if (!impl->model)
    {
        throw CoreException(gEmptyModelMessage);
...
void SBMLSolver::setFloatingSpeciesInitialConcentrationByIndex(const int& index, const double& value)
{
    if (!impl->model)
    {
        throw CoreException(gEmptyModelMessage);
...
// Help("Sets the value of a floating species by its index")
void SBMLSolver::setFloatingSpeciesByIndex(int index, double value)
{
    if (!impl->model)
    {
        throw CoreException(gEmptyModelMessage);
...
double SBMLSolver::getFloatingSpeciesByIndex(const int index)
{
    if (!impl->model)
    {
        throw CoreException(gEmptyModelMessage);
...
vector<double> SBMLSolver::getFloatingSpeciesConcentrations()
{
    if (!impl->model)
    {
        throw CoreException(gEmptyModelMessage);
...
vector<double> SBMLSolver::getFloatingSpeciesInitialConcentrations()
{
    if (!impl->model)
    {
        throw CoreException(gEmptyModelMessage);
...
void SBMLSolver::setFloatingSpeciesInitialConcentrations(const vector<double>& values)
{
    if (!impl->model)
    {
        throw CoreException(gEmptyModelMessage);
...
void SBMLSolver::setFloatingSpeciesConcentrations(const vector<double>& values)
{
    if (!impl->model)
    {
        throw CoreException(gEmptyModelMessage);
...
// Help("Set the concentrations for all floating species in the model")
void SBMLSolver::setBoundarySpeciesConcentrations(const vector<double>& values)
{
    if (!impl->model)
    {
        throw CoreException(gEmptyModelMessage);
...
int SBMLSolver::getNumberOfGlobalParameters()
{
    if (!impl->model)
    {
        throw CoreException(gEmptyModelMessage);
...
void SBMLSolver::setGlobalParameterByIndex(const int index, const double value)
{
    if (!impl->model)
    {
        throw CoreException(gEmptyModelMessage);
...
double SBMLSolver::getGlobalParameterByIndex(const int& index)
{
    if (!impl->model)
    {
        throw CoreException(gEmptyModelMessage);
...
vector<double> SBMLSolver::getGlobalParameterValues()
{
    if (!impl->model)
    {
        throw CoreException(gEmptyModelMessage);
...
double SBMLSolver::getuCC(const string& variableName, const string& parameterName)
{
    try
    {
        if (!impl->model)
...
double SBMLSolver::getCC(const string& variableName, const string& parameterName)
{
    VariableType variableType;
    ParameterType parameterType;
    int variableIndex;
...
double SBMLSolver::getUnscaledSpeciesElasticity(int reactionId, int speciesIndex)
{
    get_self();
...
DoubleMatrix SBMLSolver::getUnscaledElasticityMatrix()
{
    get_self();
...
DoubleMatrix SBMLSolver::getScaledElasticityMatrix()
{
    get_self();
...
double SBMLSolver::getScaledFloatingSpeciesElasticity(const string& reactionName,
...
DoubleMatrix SBMLSolver::getUnscaledConcentrationControlCoefficientMatrix()
{
    get_self();
...
DoubleMatrix SBMLSolver::getScaledConcentrationControlCoefficientMatrix()
{
    get_self();
...
DoubleMatrix SBMLSolver::getUnscaledFluxControlCoefficientMatrix()
{
    get_self();
...
DoubleMatrix SBMLSolver::getScaledFluxControlCoefficientMatrix()
{
    try
    {
        if (!impl->model)
...
string SBMLSolver::getSBML(int level, int version)
{
    if (level > 0) {
...
string SBMLSolver::getCurrentSBML(int level, int version)
{
    check_model();
...
void SBMLSolver::changeInitialConditions(const vector<double>& ic)
{
    if (!impl->model)
    {
        throw CoreException(gEmptyModelMessage);
...
vector<double> SBMLSolver::getReactionRates()
{
    if (!impl->model)
    {
        throw CoreException(gEmptyModelMessage);
...
Integrator* SBMLSolver::getIntegrator()
{
    updateSimulateOptions();
...
void SBMLSolver::setValue(const string& sId, double dValue)
{
    check_model();
...
double SBMLSolver::getValue(const std::string& sel)
{
    return getValue(createSelection(sel));
}


vector<double> SBMLSolver::getSelectedValues()
{
    if (!impl->model)
    {
        throw CoreException(gEmptyModelMessage);
...
SelectionRecord SBMLSolver::createSelection(const std::string& str)
{
    if (!impl->model)
    {
...
void SBMLSolver::setSelections(const vector<string>& _selList)
{
...
void SBMLSolver::setSelections(const std::vector<rr::SelectionRecord>& ss)
{
    impl->mSelectionList = ss;
}

void SBMLSolver::setSteadyStateSelections(const vector<string>& ss)
{
    impl->mSteadyStateSelection.clear();
...
void SBMLSolver::setSteadyStateSelections(const std::vector<rr::SelectionRecord>& ss)
{
...
Matrix<double> SBMLSolver::getFrequencyResponse(double startFrequency,
...
double SBMLSolver::getUnscaledParameterElasticity(const string& reactionName, const string& parameterName)
{
    int parameterIndex;
...
void SBMLSolver::getIds(int types, std::list<std::string>& ids)
{
    if (impl->model)
    {
...
int SBMLSolver::getSupportedIdTypes()
{
...
vector<string> SBMLSolver::getRateOfChangeIds()
{
    std::list<std::string> list;
...
vector<string> SBMLSolver::getCompartmentIds()
{
    std::list<std::string> list;
...
vector<string> SBMLSolver::getGlobalParameterIds()
{
    std::list<std::string> list;
...
vector<string> SBMLSolver::getBoundarySpeciesIds()
{
    std::list<std::string> list;
...
vector<string> SBMLSolver::getFloatingSpeciesInitialConditionIds()
{
    std::list<std::string> list;
...
vector<string> SBMLSolver::getReactionIds()
{
    std::list<std::string> list;
...
vector<string> SBMLSolver::getEigenValueIds()
{
    std::list<std::string> list;
...
SBMLSolverOptions& SBMLSolver::getOptions()
{
    return impl->roadRunnerOptions;
}

const DoubleMatrix* SBMLSolver::getSimulationData() const
{
    return &impl->simulationResult;
}

Integrator* SBMLSolver::getIntegrator(Integrator::IntegratorId intg)
{
    get_self();
...
void SBMLSolver::updateSimulateOptions()
{
    get_self();
