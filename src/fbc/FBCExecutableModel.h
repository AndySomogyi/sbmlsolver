/*
 * FBCExecutableModel.h
 *
 *  Created on: Feb 22, 2015
 *      Author: andy
 */

#ifndef SOURCE_FBC_FBCEXECUTABLEMODEL_H_
#define SOURCE_FBC_FBCEXECUTABLEMODEL_H_
...
class FBCExecutableModel: public ExecutableModel
{
	typedef cxx11_ns::unordered_map<std::string, uint> StringUIntMap;

public:
	FBCExecutableModel(const std::string sbml, const rr::Dictionary *dict);
	virtual ~FBCExecutableModel();
...
public:
    ...
    virtual void setEventListener(int index, EventListenerPtr eventHandler);
    virtual EventListenerPtr getEventListener(int index);
...
#endif /* SOURCE_FBC_FBCEXECUTABLEMODEL_H_ */
