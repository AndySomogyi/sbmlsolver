...
#if 1        /*HAVE_VISIBILITY*/ && BUILDING_LIBICONV
...
#endif
extern LIBICONV_DLL_EXPORTED size_t iconv (iconv_t cd, const    /*ICONV_CONST*/ char* * inbuf, size_t *inbytesleft, char* * outbuf, size_t *outbytesleft);
