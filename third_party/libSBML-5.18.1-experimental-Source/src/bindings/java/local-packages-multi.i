 ...
 */
%typemap(javacode) MultiExtension
%{
...
COVARIANT_RTYPE_CLONE(SubListOfSpeciesFeatures)
...
SBMLCONSTRUCTOR_EXCEPTION(SubListOfSpeciesFeatures)
...
//
%typemap("javaout") MultiSpeciesType*
{
	return (MultiSpeciesType) libsbml.DowncastSBase($jnicall, $owner);
}
