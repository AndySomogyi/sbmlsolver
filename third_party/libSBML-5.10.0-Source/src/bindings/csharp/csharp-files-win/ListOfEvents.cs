...
/**
   ...
   */ public
 ListOfEvents(long level, long version) : this(libsbmlPINVOKE.new_ListOfEvents__SWIG_0(level, version), true) {
...
/**
   ...
   */ public
 ListOfEvents(SBMLNamespaces sbmlns) : this(libsbmlPINVOKE.new_ListOfEvents__SWIG_1(SBMLNamespaces.getCPtr(sbmlns)), true) {
    if (libsbmlPINVOKE.SWIGPendingException.Pending) throw libsbmlPINVOKE.SWIGPendingException.Retrieve();
  }
