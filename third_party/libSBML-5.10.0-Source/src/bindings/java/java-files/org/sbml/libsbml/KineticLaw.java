...
/**
   ...
   * parent {@link SBMLDocument} object.
   <p>
   * <p>
 * @note Upon the addition of a {@link KineticLaw} object to an {@link SBMLDocument} (e.g.,
 * using {@link Reaction#setKineticLaw(KineticLaw kl)}), the SBML
 * Level, SBML Version and XML namespace of the document <em>override</em> the
 * values used when creating the {@link KineticLaw} object via this constructor.
 ...
 * creation of a {@link KineticLaw} is an important aid to producing valid SBML.
