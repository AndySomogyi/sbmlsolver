 ...
 * <em>override</em> the values used when creating the {@link AssignmentRule}
 * object via the {@link AssignmentRule}
 ...
 * values at the time of creation of a {@link AssignmentRule} is an important aid to
