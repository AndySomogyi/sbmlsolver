...
#ifndef QualUniqueModelWideIds_h
#define QualUniqueModelWideIds_h
...
/**
 * The QualUniqueModelWideIds Cosntraint is the base class for all SBML id constraints.  It
 ...
 * call getTypename().
 */
class QualUniqueModelWideIds: public TConstraint<Model>
{
public:
   ...
   */
  QualUniqueModelWideIds (unsigned int id, Validator& v);

  /**
   * Destroys this Constraint.
   */
  virtual ~QualUniqueModelWideIds ();
...
#endif  /* __cplusplus */
#endif  /* QualUniqueModelWideIds_h */
