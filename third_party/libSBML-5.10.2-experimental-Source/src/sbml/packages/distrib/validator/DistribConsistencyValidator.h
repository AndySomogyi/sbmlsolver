 ...
 * @brief:  Implementation of the DistribConsistencyValidator class
 * @author: SBMLTeam
 *
 * <!--------------------------------------------------------------------------
...
#ifndef DistribConsistencyValidator_H__
#define DistribConsistencyValidator_H__
...
class DistribConsistencyValidator: public DistribValidator
{
public:
