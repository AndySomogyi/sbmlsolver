...
typedef enum
{
  ...
  , SBML_MULTI_SPECIES_TYPE_COMPONENT_INDEX = 1409
  , SBML_MULTI_SPECIES_FEATURE     = 1410
  , SBML_MULTI_SPECIES_TYPE_COMPONENT_MAP_IN_PRODUCT = 1411
  , SBML_MULTI_SPECIES_TYPE        = 1412
} SBMLMultiTypeCode_t;
