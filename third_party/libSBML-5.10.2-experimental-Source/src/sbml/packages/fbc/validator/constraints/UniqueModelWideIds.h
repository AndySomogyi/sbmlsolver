...
#ifndef UniqueModelWideIds_h
#define UniqueModelWideIds_h
...
/**
 * The UniqueModelWideIds Cosntraint is the base class for all SBML id constraints.  It
 ...
 * call getTypename().
 */
class UniqueModelWideIds: public TConstraint<Model>
{
public:
   ...
   */
  UniqueModelWideIds (unsigned int id, Validator& v);

  /**
   * Destroys this Constraint.
   */
  virtual ~UniqueModelWideIds ();
