...
static Variant values[] =  {
    ...
    Variant(true),      // STEADYSTATE_START_WITH_APPROX
    Variant(1.e-6),    // STEADYSTATE_START_WITH_APPROX_TOL
    Variant(10000),      // STEADYSTATE_START_WITH_APPROX_MAX_STEPS
    Variant(10000),      // STEADYSTATE_START_WITH_APPROX_TIME
...
static void getKeyNames(StringIntMap& keys)
{
    ...
    keys["STEADYSTATE_START_WITH_APPROX"] = rr::Config::STEADYSTATE_START_WITH_APPROX;
    keys["STEADYSTATE_START_WITH_APPROX_TOL"] = rr::Config::STEADYSTATE_START_WITH_APPROX_TOL;
    keys["STEADYSTATE_START_WITH_APPROX_MAX_STEPS"] = rr::Config::STEADYSTATE_START_WITH_APPROX_MAX_STEPS;
    keys["STEADYSTATE_START_WITH_APPROX_TIME"] = rr::Config::STEADYSTATE_START_WITH_APPROX_TIME;
...
Config::Keys Config::stringToKey(const std::string& key) {
    ...
    else if (key == "STEADYSTATE_START_WITH_APPROX")
        return Config::STEADYSTATE_START_WITH_APPROX;
    else if (key == "STEADYSTATE_START_WITH_APPROX_TOL")
        return Config::STEADYSTATE_START_WITH_APPROX_TOL;
    else if (key == "STEADYSTATE_START_WITH_APPROX_MAX_STEPS")
        return Config::STEADYSTATE_START_WITH_APPROX_MAX_STEPS;
    else if (key == "STEADYSTATE_START_WITH_APPROX_TIME")
        return Config::STEADYSTATE_START_WITH_APPROX_TIME;
