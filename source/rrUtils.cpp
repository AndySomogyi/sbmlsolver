...
#include <mach/mach_time.h>
    ...
    static mach_timebase_info_data_t initMicroSeconds() {
        mach_timebase_info_data_t info;
        mach_timebase_info(&info);
        return info;
    }

    static mach_timebase_info_data_t info = initMicroSeconds();
...
#include <windows.h>
    ...
    static double initMicroSeconds() {
    ...
    static double PCFreq = initMicroSeconds();
...
#include <stdint.h>
    ...
    static uint64_t initMicroSeconds() {
    ...
    static uint64_t rdtsc_per_sec = initMicroSeconds();
