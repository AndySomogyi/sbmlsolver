...
/******************************************************************************/
        ...
        */
         ...
         */
        void addSpecies(const std::string &sid, const std::string &compartment, double initAmount = 0,
        ...
        *					      set this flag to true only in the last call of editing
        */
        void addReaction(const std::string &rid, std::vector<string> reactants, std::vector<string> products,
        ...
        */
         ...
         * This method was private in roadrunner 2.0.1 but made public in Ciaran Welsh's copy. If this
         * change makes the main roadrunner repository, please remove this comment.
         */
