...
//    CopyCArrayToStdVector(model.y,                        mFloatingSpeciesConcentrations,       *model.ySize);
    copyCArrayToStdVector(modelData.boundarySpeciesConc,      mBoundarySpeciesConcentrations,       modelData.boundarySpeciesNum);
...
//    CopyStdVectorToCArray(mFloatingSpeciesConcentrations,   model.y,                        *model.ySize                        );
    copyStdVectorToCArray(mBoundarySpeciesConcentrations,   modelData.boundarySpeciesConc,      modelData.boundarySpeciesNum                       );
