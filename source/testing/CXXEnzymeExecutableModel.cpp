...
int CXXEnzymeExecutableModel::getGlobalParameterInitValues(int len, int const * indx, double * values)
{
    return 0;
}

int CXXEnzymeExecutableModel::setGlobalParameterInitValues(int len, int const * indx, const double * values)
{
    return 0;
}
