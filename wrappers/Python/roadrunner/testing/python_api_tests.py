...
class RoadRunnerTests(unittest.TestCase):
    ...
    def test___class__(self):
        ...
        """
        self.assertEqual(226, len(dir(self.rr.__class__)))
    ...
    def test___dir__(self):
        ...
        your build, just delete it.
        """
        self.assertEqual(227, len(dir(self.rr)))
    ...
    def testAddCompartment(self):
        ...
        attribute.
        """
        self.rr._addCompartment("C1", 1, True)
        print(type(self.rr.C1))
    ...
    # def test_keys(self):
    #     print(self.rr.keys())
    #     expected = ['S2', 'S1', 'S3', '[S2]', '[S1]', '[S3]', 'default_compartment', 'k1', 'k2', '_J0', '_J1', 'init([S2])', 'init(S2)', "S2'", 'eigen(S2)', 'eigenReal(S2)', 'eigenImag(S2)']
    #     self.assertEqual(
    #         expected,
    #         self.rr.keys(),
    #     )
