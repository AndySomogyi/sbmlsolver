...
# of the sidebar.
html_logo = "libroadrunner_logo_tan_200.png"

# The name of an image file (within the static path) to use as favicon of the
# docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
html_favicon = "../../../installer/windows/libroadrunner_logo_tan.ico"
...
latex_documents = [
  ('index', 'RoadRunner.tex', u'RoadRunner Documentation',
   u'Andy Somogyi, J Kyle Medley, Kiri Choi, Herbert Suaro', 'manual'),
]
...
man_pages = [
    ('index', 'roadrunner', u'RoadRunner Documentation',
     [u'Andy Somogyi, J Kyle Medley, Kiri Choi, Herbert Suaro'], 1)
]
...
texinfo_documents = [
  ('index', 'RoadRunner', u'RoadRunner Documentation',
   u'Andy Somogyi, J Kyle Medley, Kiri Choi, Herbert Suaro', 'RoadRunner', 'One line description of project.',
   'Miscellaneous'),
]
