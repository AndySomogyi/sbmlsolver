...
Identifier 
    Any continious sequence of printing characters is treated as an SBML identifier with
...
----------------------------
The columns of the RoadRunner simulation results are determined by the :attr:`RoadRunner.selections` 
