...
where :math:`F_i` is the ith differential equation and :math:`S_i` the ith floating species. From RoadRunner it is easy to obtain the Jacobian matrix using :cpp::class:`rr::RoadRunner::getFullJacobian`, i.e.::
