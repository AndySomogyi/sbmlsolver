...
To reliably pick the build type, you must explicitly specify the build type twice, once at configure time and again at build time. During configure time ensure you have provided an argument to `CMAKE_BUILD_TYPE`, i.e.:
