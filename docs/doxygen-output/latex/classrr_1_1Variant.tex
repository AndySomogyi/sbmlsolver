...
\begin{DoxyCompactList}\small\item\em Converts the \mbox{\hyperlink{classrr_1_1Variant}{Variant}} to a string in J\+S\+ON format. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em is this variant a string. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Parses the string which must be in J\+S\+ON format. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{// to convert to string:}}
...
\DoxyCodeLine{\mbox{\hyperlink{classrr_1_1Variant_a48f0736e18b6463303047b46cccca550}{Variant}} v = std::string(\textcolor{stringliteral}{"{}a string"{}});}
\end{DoxyCode}
...
Parses the string which must be in J\+S\+ON format. 

This is a common way to read a \mbox{\hyperlink{classrr_1_1Variant}{Variant}} from a file or create a new one from a string\+: 
\begin{DoxyCode}{0}
...
\DoxyCodeLine{    cout << \textcolor{stringliteral}{"{}its an int"{}};}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{// to check if its a string:}}
\DoxyCodeLine{\textcolor{keywordflow}{if} (v.type() == \textcolor{keyword}{typeid}(std::string))}
\DoxyCodeLine{    cout << \textcolor{stringliteral}{"{}ints a string"{}};}
\end{DoxyCode}
