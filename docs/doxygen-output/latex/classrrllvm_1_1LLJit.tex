\hypertarget{classrrllvm_1_1LLJit}{}\doxysection{rrllvm\+::LLJit Class Reference}
...
{\ttfamily \#include $<$LLJit.\+h$>$}

Inheritance diagram for rrllvm\+::LLJit\+:\begin{figure}[H]
\begin{center}
\leavevmode
...
\item 
std\+::string \mbox{\hyperlink{classrrllvm_1_1LLJit_a88bb307456fc1c38e25cb031e604c430}{mangle\+Name}} (const std\+::string \&unmangled\+Name) const override
\item 
\mbox{\hyperlink{classrrllvm_1_1LLJit_a33665b939c76efb7849ac0c55ddffdbb}{LLJit}} (std\+::uint32\+\_\+t options)
\item 
...
std\+::uint64\+\_\+t \mbox{\hyperlink{classrrllvm_1_1LLJit_a7c19af88fe0dc1ad16bf809a78e4dec6}{lookup\+Function\+Address}} (const std\+::string \&name) override
\item 
...
\item 
void \mbox{\hyperlink{classrrllvm_1_1LLJit_a896e1f6a4c0087c1cfec2271c018cdfd}{add\+Module}} (std\+::unique\+\_\+ptr$<$ llvm\+::\+Module $>$ M, std\+::unique\+\_\+ptr$<$ llvm\+::\+LLVMContext $>$ ctx) override
\begin{DoxyCompactList}\small\item\em add a module \end{DoxyCompactList}\item 
std\+::unique\+\_\+ptr$<$ llvm\+::\+Memory\+Buffer $>$ \mbox{\hyperlink{classrrllvm_1_1LLJit_ae81a46694d77eba74473d015b42e01f7}{get\+Compiled\+Model\+From\+Cache}} (const std\+::string \&sbml\+MD5) override
...
llvm\+::orc\+::\+LLJIT $\ast$ {\bfseries get\+LLJit\+Non\+Owning} ()
\item 
...
std\+::string \mbox{\hyperlink{classrrllvm_1_1LLJit_ab7a58cc6be141daf6141498dace4f837}{get\+Module\+As\+String}} (std\+::string sbml\+MD5) override
...
\begin{DoxyCompactItemize}
\item 
\mbox{\Hypertarget{classrrllvm_1_1LLJit_a26f054167cb868b224b4d10f0344c953}\label{classrrllvm_1_1LLJit_a26f054167cb868b224b4d10f0344c953}} 
std\+::ostream \& {\bfseries operator$<$$<$} (std\+::ostream \&os, \mbox{\hyperlink{classrrllvm_1_1LLJit}{LLJit}} $\ast$ll\+Jit)
...
The interface for \mbox{\hyperlink{classrrllvm_1_1LLJit}{LLJit}} is used as a framework 
...
{\footnotesize\ttfamily rrllvm\+::\+LLJit\+::\+LLJit (\begin{DoxyParamCaption}\item[{std\+::uint32\+\_\+t}]{options }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [explicit]}}

Create a JTMB.

This is moved into the LLJit\+Builder and becomes harder to access, so pull out things which we need later on and store them as member variables.

None, Less, Default or Aggressive are the options.

todo expose as option to user

Set a custom compile function that 1) caches objects and 2) stores a pointer to the target\+Machine for access later. The target\+Machine pointer is owned by the JITTarget\+Machine\+Builder.
...
{\footnotesize\ttfamily void rrllvm\+::\+LLJit\+::add\+Module (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [override]}, {\ttfamily [virtual]}}
...
similar to \mbox{\hyperlink{classrrllvm_1_1LLJit_a896e1f6a4c0087c1cfec2271c018cdfd}{add\+Module(std\+::unique\+\_\+ptr$<$llvm\+::\+Module$>$ M, std\+::unique\+\_\+ptr$<$llvm\+::\+LLVMContext$>$ ctx)}} the references are stolen by the call to construct a Thread\+Safe\+Module which then takes ownership of the module and context. 
...
{\footnotesize\ttfamily void rrllvm\+::\+LLJit\+::add\+Module (\begin{DoxyParamCaption}\item[{llvm\+::\+Module $\ast$}]{M }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [override]}, {\ttfamily [virtual]}}
...
{\footnotesize\ttfamily void rrllvm\+::\+LLJit\+::add\+Module (\begin{DoxyParamCaption}\item[{std\+::unique\+\_\+ptr$<$ llvm\+::\+Module $>$}]{M,  }\item[{std\+::unique\+\_\+ptr$<$ llvm\+::\+LLVMContext $>$}]{ctx }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [override]}, {\ttfamily [virtual]}}
...
{\footnotesize\ttfamily void rrllvm\+::\+LLJit\+::add\+Object\+File (\begin{DoxyParamCaption}\item[{rr\+Owning\+Binary}]{owning\+Object }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [override]}, {\ttfamily [virtual]}}
...
{\footnotesize\ttfamily void rrllvm\+::\+LLJit\+::add\+Object\+File (\begin{DoxyParamCaption}\item[{std\+::unique\+\_\+ptr$<$ llvm\+::\+Memory\+Buffer $>$}]{obj }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [override]}, {\ttfamily [virtual]}}
...
{\footnotesize\ttfamily void rrllvm\+::\+LLJit\+::add\+Object\+File (\begin{DoxyParamCaption}\item[{std\+::unique\+\_\+ptr$<$ llvm\+::object\+::\+Object\+File $>$}]{object\+File }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [override]}, {\ttfamily [virtual]}}
...
{\footnotesize\ttfamily std\+::unique\+\_\+ptr$<$ llvm\+::\+Memory\+Buffer $>$ rrllvm\+::\+LLJit\+::get\+Compiled\+Model\+From\+Cache (\begin{DoxyParamCaption}\item[{const std\+::string \&}]{sbml\+MD5 }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [override]}, {\ttfamily [virtual]}}



lookup a model in the roadrunner object cache and return a memory buffer to it. 

When compiled (with \mbox{\hyperlink{classrrllvm_1_1LLJit}{LLJit}}), object files are stored in the \mbox{\hyperlink{classrrllvm_1_1SBMLModelObjectCache}{SBMLModel\+Object\+Cache}}. This is basically a string to Memory\+Buffer map, where the string is the sbml\textquotesingle{}s md5. In the case where the moiety conservation is turned on, the sbml\+MD5 will be identical. Therefore it is appended with the string \char`\"{}\+\_\+conserved\char`\"{}. 
...
\index{rrllvm::LLJit@{rrllvm::LLJit}!getDataLayout@{getDataLayout}}
\index{getDataLayout@{getDataLayout}!rrllvm::LLJit@{rrllvm::LLJit}}
\doxysubsubsection{\texorpdfstring{getDataLayout()}{getDataLayout()}}
{\footnotesize\ttfamily const llvm\+::\+Data\+Layout \& rrllvm\+::\+LLJit\+::get\+Data\+Layout (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption}) const\hspace{0.3cm}{\ttfamily [override]}, {\ttfamily [virtual]}}
...
{\footnotesize\ttfamily std\+::string rrllvm\+::\+LLJit\+::get\+Module\+As\+String (\begin{DoxyParamCaption}\item[{std\+::string}]{sbml\+MD5 }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [override]}, {\ttfamily [virtual]}}
...
\index{rrllvm::LLJit@{rrllvm::LLJit}!lookupFunctionAddress@{lookupFunctionAddress}}
\index{lookupFunctionAddress@{lookupFunctionAddress}!rrllvm::LLJit@{rrllvm::LLJit}}
\doxysubsubsection{\texorpdfstring{lookupFunctionAddress()}{lookupFunctionAddress()}}
{\footnotesize\ttfamily std\+::uint64\+\_\+t rrllvm\+::\+LLJit\+::lookup\+Function\+Address (\begin{DoxyParamCaption}\item[{const std\+::string \&}]{name }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [override]}, {\ttfamily [virtual]}}
...
\index{rrllvm::LLJit@{rrllvm::LLJit}!mangleName@{mangleName}}
\index{mangleName@{mangleName}!rrllvm::LLJit@{rrllvm::LLJit}}
\doxysubsubsection{\texorpdfstring{mangleName()}{mangleName()}}
{\footnotesize\ttfamily std\+::string rrllvm\+::\+LLJit\+::mangle\+Name (\begin{DoxyParamCaption}\item[{const std\+::string \&}]{unmangled\+Name }\end{DoxyParamCaption}) const\hspace{0.3cm}{\ttfamily [override]}, {\ttfamily [virtual]}}
...
\item 
llvm/LLJit.\+h\item 
llvm/LLJit.\+cpp\end{DoxyCompactItemize}
