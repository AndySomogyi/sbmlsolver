...
{\bfseries Setting} (setting\+\_\+t value)
...
{\footnotesize template$<$class T $>$ }\\T $\ast$ \mbox{\hyperlink{classrr_1_1Setting_aab0c3dd0b0a5bb7f68c9c6dc25945463}{get\+\_\+if}} ()
...
\mbox{\hyperlink{classrr_1_1Setting}{Setting}} \& {\bfseries operator=} (\mbox{\hyperlink{classrr_1_1Setting}{Setting}} \&\&setting) noexcept
...
{\bfseries Setting} (const \mbox{\hyperlink{classrr_1_1Setting}{Setting}} \&setting)
...
{\bfseries Setting} (\mbox{\hyperlink{classrr_1_1Setting}{Setting}} \&\&setting) noexcept
...
const setting\+\_\+t \& {\bfseries get\+Value} () const
...
{\footnotesize template$<$class T $>$ }\\static bool {\bfseries is\+Valid\+Type} ()
...
Setting\+Type\+::get() 
\end{DoxySeeAlso}
\mbox{\Hypertarget{classrr_1_1Setting_aab0c3dd0b0a5bb7f68c9c6dc25945463}\label{classrr_1_1Setting_aab0c3dd0b0a5bb7f68c9c6dc25945463}} 
...
\item converting a long that has a value \texorpdfstring{$>$}{>} the largest possible value for int to int \begin{DoxyNote}{Note}
...
\DoxyCodeLine{}
\DoxyCodeLine{template<typename T, class = typename std::enable\_if<isValidVariantType<T, setting\_t>::value>\mbox{\hyperlink{classrr_1_1Setting_a479708abc63de00aca3d56b7e28bee04}{::type}}>}
\DoxyCodeLine{\mbox{\hyperlink{classrr_1_1Setting_a2f3f6beff36ad237ca6493dfaa19741f}{Setting}} \&\mbox{\hyperlink{classrr_1_1Setting_adcf3783161d25aa1082673116eb44df0}{operator=}}(T \&\&setting) \textcolor{keyword}{noexcept} \{}
\DoxyCodeLine{    checkValidType<T>();}
\DoxyCodeLine{    \textcolor{comment}{// no need to check self assignment with variant}}
