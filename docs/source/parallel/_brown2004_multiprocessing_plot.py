...
# without the second call to the pass manager for every function
simple_flux_parallel_llvm_13_no_fn_opt_pass = pd.DataFrame({
    1: 0.6424722671508789,
    10: 0.5899207592010498,
    100: 0.6639833450317383,
    1000: 1.2549240589141846,
    10000: 6.778643369674683,
    100000: 63.90140128135681,
}, index=['parallel'])

# without the second call to the pass manager for every function
simple_flux_serial_llvm13_no_fn_opt_pass = pd.DataFrame({
    1: 0.03168296813964844,
    10: 0.031258344650268555,
    100: 0.32019495964050293,
    1000: 3.109968662261963,
    10000: 32.32715201377869,
    100000: 303.8615641593933,
}, index=['serial'])
